...
-- GRANT EXECUTE ON mudar_password TO 'UTILIZADOR'@'localhost';

-- | RC5. Utilizadores podem visualizar e reagir às viagens. Podem, também, atualizar ou remover a visualização.
-- GRANT EXECUTE ON inserir_visualização TO 'UTILIZADOR'@'localhost';
-- GRANT EXECUTE ON atualizar_visualização TO 'UTILIZADOR'@'localhost';
-- GRANT EXECUTE ON remover_visualização TO 'UTILIZADOR'@'localhost';
...
-- GRANT EXECUTE ON mudar_password TO 'SOCIO'@'localhost';
-- GRANT EXECUTE ON inserir_visualização TO 'SOCIO'@'localhost';
-- GRANT EXECUTE ON atualizar_visualização TO 'SOCIO'@'localhost';
-- GRANT EXECUTE ON remover_visualização TO 'SOCIO'@'localhost';
